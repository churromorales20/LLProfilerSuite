<template>
  <div class="ll-box shadow rounded-lg p-4 mt-4" v-if="isValidGraveyardInfo">
    <h2 class="text-md border-b-2 ll-border-heading pb-2 ll-box-title-main lg:text-lg font-bold mb-2">{{ $t('profile.graveyard_directions') }}</h2>
